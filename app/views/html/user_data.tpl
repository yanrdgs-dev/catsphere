...
<head>
    ...
    <title>Dados do Usuário - Catsphere</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="/static/css/user_data.css" rel="stylesheet">
</head>
<body>
            ...
            <form>
                ...
                <div class="mb-3">
                    ...
                    <div class="input-group">
                        <input type="password" id="password" class="form-control" value="{{ current_user.password }}" readonly>
